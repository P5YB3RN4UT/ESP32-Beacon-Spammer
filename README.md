...
Note: The firmware comes with ten presets that are completely customisable at code level. Currently on this build I have created seven ready-to-go presets and left three blank. The seven ready-to-go presets are as follows:
...
6. HICKSROLL: <i>Wise words from the late outlaw comic Bill Hicks.</i>
